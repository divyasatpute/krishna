import {
  PaneItem
} from "./chunk-DTXTU2IR.js";
import {
  useDeskToolSetting
} from "./chunk-USI7BCPQ.js";
import "./chunk-UUEYC73N.js";
import {
  BackLink,
  Delay,
  Pane,
...
function LoadingView(props) {
  ...
  return (0, import_jsx_runtime.jsx)(Stack, {
    padding: 2,
    space: 1,
    children: SKELETON_ITEMS.map((num) => (0, import_jsx_runtime.jsx)(Card, {
      padding: 2,
...
function DocumentListPaneContent(props) {
  ...
  const renderItem = (0, import_react.useCallback)((item, _ref) => {
    ...
    return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
      children: [(0, import_jsx_runtime.jsx)(PaneItem, {
        ...
        selected,
        value: item
      }), showSpinner && (0, import_jsx_runtime.jsx)(Flex, {
        align: "center",
        justify: "center",
        padding: 4,
      ...
      }), showMaxItemsMessage && (0, import_jsx_runtime.jsx)(Box, {
        marginY: 1,
        paddingX: 3,
        paddingY: 4,
  ...
  const mainContent = (0, import_react.useMemo)(() => {
    ...
    if (loadingVariant === "initial" && isLoading) {
      return (0, import_jsx_runtime.jsx)(Delay, {
        ms: 300,
        children: (0, import_jsx_runtime.jsx)(LoadingView, {
          layout
        })
      });
    }
    ...
    return (0, import_jsx_runtime.jsx)(RootBox, {
      overflow: "hidden",
      height: "fill",
      children: (0, import_jsx_runtime.jsx)(CommandListBox, {
...
var EMPTY_ARRAY = [];
var rotate = We(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"])));
...
var DocumentListPane = (0, import_react.memo)(function DocumentListPane2(props) {
  ...
  const searchInput = (0, import_jsx_runtime.jsx)(Box, {
    paddingX: 2,
    paddingBottom: 2,
    children: (0, import_jsx_runtime.jsx)(SearchCard, {
      radius: 4,
      tone: "transparent",
...
//# sourceMappingURL=index-3e777261-4ZZETAZI.js.map
